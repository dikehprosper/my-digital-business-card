...
<main className="app_main">
    ...
    <div className="button">
       <a href="mailto:dike.prosper.dp@gmail.com">
       <button className="button_email"><svg width="13" height="10" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
LinkedIn</button>
    ...
    <p>Food expert. Music scholar. Reader. Internet 
        ...
        geek. Pop culture ninja. Coffee fanatic.</p>
    </div>
